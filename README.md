...
Modern durak models the russian card game [durak](https://en.wikipedia.org/wiki/Durak). Durak is russian and means fool. The name modern durak is a joke combining 'modern' from modern c++ and 'durak' from the game durak. You can play online against other players (quick game, ranked game) or play against a computer controlled opponent (puzzle). I am self hosting the game [here](https://modern-durak.com).
### how to deploy
